...
Currently, the following functions are implemented: `future_apply()`, `future_eapply()`, `future_lapply()`, `future_replicate()`, `future_sapply()`, `future_tapply()`, and `future_vapply()`.
