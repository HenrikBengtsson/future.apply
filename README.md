...
The API and identify of the future.apply package will be kept close to the `*apply()` functions on base R.  In other words, it will _neither_ keep growing nor be expanded with new, more powerful apply-like functions beyond those core ones in base R.  Such extended functionality should be part of a separate package.
